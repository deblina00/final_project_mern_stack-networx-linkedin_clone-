...
const LandingPage = (props) => {
  return (
    <div className="w-full">
      {/* ================= HERO SECTION ================= */}
      <div className="my-8 py-[50px] md:px-[120px] px-5 flex flex-col md:flex-row justify-between gap-10">
        <div className="md:w-[45%] flex flex-col items-center md:items-start">
          ...
          <div className="flex mx-auto md:mx-0 mt-7 py-2 px-2 w-[90%] sm:w-[80%] md:w-[70%]">
            <GoogleLoginComp changeLoginValue={props.changeLoginValue} />
          </div>

          <Link
            to={"/login"}
            className="flex mx-auto md:mx-0 mt-4 py-2.5 px-4 bg-white border border-purple-300 shadow-[0_0_10px_rgba(168,85,247,0.2)] hover:bg-purple-50 hover:shadow-[0_0_15px_rgba(168,85,247,0.35)] transition-all duration-200 text-gray-700 font-medium rounded-4xl w-[90%] sm:w-[80%] md:w-[70%] justify-center cursor-pointer"
          >
            Sign in with Email
          </Link>

          <div className="mx-auto md:mx-0 mb-4 text-sm w-[90%] sm:w-[80%] md:w-[70%] mt-6 text-gray-600 leading-relaxed text-center md:text-left">
          ...
          <Link
            to={"/signup"}
            className="mx-auto md:mx-0 text-center text-lg w-[90%] sm:w-[80%] md:w-[70%] mt-2"
          >
            New to Networx?{" "}
        ...
        <div className="md:w-[50%] mt-10 md:mt-0 flex items-center justify-center">
          <img
            alt="networking"
            className="w-full max-w-[500px] h-auto rounded-xl shadow-lg shadow-purple-200"
            src={
      ...
      <div className="bg-gray-50 py-16 px-5 md:px-[120px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={topic}
              className="p-5 bg-white shadow-md rounded-xl border border-gray-300 hover:shadow-xl hover:border-purple-400 transition-all cursor-pointer text-center"
            >
      ...
      <div className="py-20 px-5 md:px-[120px]">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10">
          {[
            ...
            <div
              key={index}
              className="p-6 rounded-xl bg-white shadow-lg border border-gray-300 text-center"
            >
              ...
              <p className="text-gray-600">
                {index === 0 &&
                  "Discover opportunities tailored to your goals and connect with professionals worldwide."}
                {index === 1 &&
      ...
      <div className="bg-purple-50 py-16 px-5 md:px-[120px] rounded-t-3xl">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {["Jobs", "People", "Learning"].map((item) => (
            <div
              key={item}
              className="bg-white border border-gray-300 shadow-md rounded-xl p-6 hover:shadow-xl hover:border-purple-500 transition-all cursor-pointer text-center"
            >
      ...
      <div className="py-20 px-5 md:px-[120px] text-center">
        ...
        <p className="text-gray-700 mt-3 max-w-[700px] mx-auto text-sm md:text-base">
